						...
						<div class="row">
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									...
									<div class="button5">
                                        <div id="checkoutWarning" style="display: none; color: red;">You do not have any items in your cart.</div>
										<a href="{{route('checkout')}}" class="btn" id="checkoutButton">Checkout</a><!-- Warning message -->

                                        <script>
                                            document.addEventListener("DOMContentLoaded", function() {
                                                // Get reference to the link and the warning message
                                                let link = document.getElementById("checkoutButton");
                                                let warningMessage = document.getElementById("checkoutWarning");
