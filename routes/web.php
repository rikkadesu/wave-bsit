...
Route::group(['middleware'=>['revalidate_back_history']], function(){
    ...
    // Reset password
        ...
        Route::post('password-reset', [FrontendController::class, 'forgotPassword'])->name('password.email');
    // Verify
        Route::get('email/verify/{token}', [FrontendController::class, 'emailVerify']);
        Route::get('password/verify/{token}', [FrontendController::class, 'passwordVerify']);
        Route::post('/change_password/{id}/{token}', [FrontendController::class, 'changePassword'])->name('changePassword');
    // Socialite
...
// Backend section start
    ...
    Route::group(['prefix' => '/admin', 'middleware' => ['auth', 'admin', 'custom_auth']], function () {
...
// User section start
    Route::group(['prefix' => '/user', 'middleware' => ['user', 'custom_auth']], function () {
...
// Product Rating
    Route::get('/dashboard', [ProducRatingController::class, 'index'])->name('dashboard.index');